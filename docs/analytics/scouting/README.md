...
The supported undergraduate-facing 2026 opponent trends notebook is:
...
The scouting/ML readiness command is:

```bash
.venv/bin/python pipeline/scouting/build_model_readiness_report.py --org cofc --train-season 2025 --target-season 2026
```

Use this as the pre-scouting checkpoint. It verifies whether training data,
...
- `pipeline/outputs/reports/scouting/2026/model_readiness_report.md`
